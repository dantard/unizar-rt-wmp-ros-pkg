...
#define ATH5K_ERR(_sc, _fmt, ...) \
	printk("ath5k error:" _fmt, ##__VA_ARGS__)
...
#define AR5K_TUNE_DEFAULT_TXPOWER		36
...
extern int ath5k_hw_reset(struct ath5k_hw *ah, struct ieee80211_channel *channel, bool change_channel);
